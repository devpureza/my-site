...
@section('content')
    <div class="container">
        ...
        <div class="header">
            <div class="header-content" id="home">
                ...
                <h1 class="name">Sou Mateus, <span class="title">Designer editorial e Desenvolvedor PHP com mais de <br> 6
                        anos de experiência.</span></h1>

                <div class="status">
                    <p><span class="status-highlight">Disponível</span> · Design editorial - Projetos Web - Consultoria</p>
                    <p>Entre em contato para discutirmos seu projeto → <a
                            href="mailto:mateus@gmail.com">mateus@gmail.com</a></p>
                </div>
            </div>
                    ...
                    <div class="terminal-window">
                        ...
                        <div class="terminal-body">
                            ...
                            <div class="command-output">
                                <p>Olá! Sou um profissional apaixonado por design editorial e desenvolvimento web.</p>
                                <p>Com mais de 6 anos de experiência na diagramação de jornais impressos no Diário da Manhã, tenho vários projetos pessoais de
                                desenvolvimento de sistemas web, incluindo o DM Acervo e outros projetos inovadores.</p>
    ...
    <span style="color: #32CD32">private</span> <span style="color: #FFA500">$technicalSkills</span> = [
        <span style="color: #9370DB">'PHP'</span> => <span style="color: #9370DB">'Avançado'</span>,
        <span style="color: #9370DB">'Laravel'</span> => <span style="color: #9370DB">'Avançado'</span>,
        <span style="color: #9370DB">'MySQL'</span> => <span style="color: #9370DB">'Intermediário'</span>,
        <span style="color: #9370DB">'Git'</span> => <span style="color: #9370DB">'Intermediário'</span>,
        <span style="color: #9370DB">'Indesign'</span> => <span style="color: #9370DB">'Expert'</span>,
        <span style="color: #9370DB">'Photoshop'</span> => <span style="color: #9370DB">'Expert'</span>
    ];

    <span style="color: #32CD32">private</span> <span style="color: #FFA500">$softSkills</span> = [
        <span style="color: #9370DB">'Liderança'</span> => <span style="color: #9370DB">'Avançado'</span>,
        <span style="color: #9370DB">'Comunicação'</span> => <span style="color: #9370DB">'Expert'</span>,
        <span style="color: #9370DB">'Resolução'</span> => <span style="color: #9370DB">'Expert'</span>
    ];
    ...
    <span style="color: #32CD32">public</span> <span style="color: #4169E1">function</span> <span style="color: #FFA500">lead</span>(<span style="color: #FFA500">$team</span>) {
        <span style="color: #FF69B4">return</span> <span style="color: #9370DB">'Líder Tech & Designer'</span>;
    }
}</code></pre>
                    </div>
                </div>
